      ...
      {!isLoading && (
        ...
        >
          ...
          <div className="mx-40 my-14 flex justify-end gap-2">
            <button
              onClick={(event) => handleStudentResetData(event)}
              className="w-[100px] bg-base_red text-white font-medium px-6 py-2 rounded-md hover:bg-transparent hover:ring-2 hover:ring-base_red"
            >
              Reset
            </button>
            <button
